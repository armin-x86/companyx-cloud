...
module "vpc" {
  #ts:skip=AC_AWS_0369 | Flow log is not desired in my test scenario
  ...
  single_nat_gateway     = var.single_nat_gateway_enabled
  one_nat_gateway_per_az = var.one_nat_gateway_per_az_enabled
  create_igw             = true
  ...
  reuse_nat_ips       = var.reuse_nat_ips_enabled
